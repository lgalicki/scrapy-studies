...
# Scrapy settings for cl_login project
#
...
SPIDER_MODULES = ['cl_login.spiders']
NEWSPIDER_MODULE = 'cl_login.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'cl_login (+http://www.yourdomain.com)'
...
#SPIDER_MIDDLEWARES = {
#    'cl_login.middlewares.ClLoginSpiderMiddleware': 543,
#}

# Enable or disable downloader middlewares
# See https://doc.scrapy.org/en/latest/topics/downloader-middleware.html
#DOWNLOADER_MIDDLEWARES = {
#    'cl_login.middlewares.ClLoginDownloaderMiddleware': 543,
#}
...
#ITEM_PIPELINES = {
#    'cl_login.pipelines.ClLoginPipeline': 300,
#}
